...
public class ChatbotAccountServiceImpl implements ChatbotAccountService {
    ...
    @Override
    public Optional<ChatbotAccount> findByUserAndProvider(User user, ChatbotPlatform chatbotPlatform) {
        return chatbotAccountRepository.findByUserAndChatbotPlatform(user, chatbotPlatform);
    }
    ...
    @Override
    public void deleteByUserAndProvider(User user, ChatbotPlatform chatbotPlatform) {
        chatbotAccountRepository.deleteByUserAndChatbotPlatform(user, chatbotPlatform);
    }
}

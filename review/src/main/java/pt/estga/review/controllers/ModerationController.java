...
public class ModerationController {
    ...
    @GetMapping("/spatial-clusters")
    public Page<SpatialClusterListDto> spatialClusters(@PageableDefault(size = 20) Pageable pageable) {
        return moderationService.findSpatialClusters(pageable);
    }
}
